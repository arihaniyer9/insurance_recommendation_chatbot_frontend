...
const ChatInterface = () => {
  ...
  // Check authentication and fetch chat history
  useEffect(() => {
        ...
        <Container maxWidth="md" sx={{ mt: 8 }}>
          <Card sx={{ 
            ...
            <Typography variant="body1" paragraph sx={{ mb: 3 }}>
              To use our insurance recommendation chatbot, please sign in to your account.
            </Typography>
            <Typography variant="body2" color="text.secondary" paragraph sx={{ mb: 4 }}>
              Our AI-powered chatbot will guide you through personalized insurance recommendations based on your needs and preferences.
            </Typography>
    ...
    <div>
      ...
      <Container>
        <Box sx={{ my: 4 }}>
          ...
          <Box sx={{ mb: 2 }}>
            <Typography component="label" variant="subtitle1" sx={{ mr: 1 }}>
              Choose Language: 
            </Typography>
            <select 
              value={language} 
          ...
          {!submitted && (
            <Box sx={{ textAlign: 'center', mt: 8 }}>
              ...
              <Typography variant="body1" paragraph sx={{ mb: 4 }}>
                Get personalized insurance recommendations tailored to your needs.
              </Typography>
              <Button 
                variant="contained" 
                size="large" 
